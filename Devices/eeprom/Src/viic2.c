...
#define VIIC_SDA_H					GPIO_SetBits(GPIOB,GPIO_Pin_7)
#define VIIC_SDA_DATA               (GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_7) == Bit_SET)
#define VIIC_SDA_DIR_OUT            
#define VIIC_SDA_DIR_IN             GPIO_SetBits(GPIOB,GPIO_Pin_7)
#endif
