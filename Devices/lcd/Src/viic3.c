...
/* Private define ------------------------------------------------------------*/
#if defined (DEMO_STM32F091)
#define VIIC_SCL_L                  GPIO_ResetBits(GPIOE,GPIO_Pin_11)
#define VIIC_SCL_H					GPIO_SetBits(GPIOE,GPIO_Pin_11)
#define VIIC_SDA_L					GPIO_ResetBits(GPIOE,GPIO_Pin_12)
#define VIIC_SDA_H					GPIO_SetBits(GPIOE,GPIO_Pin_12)
#define VIIC_SDA_DATA               (GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_12) == Bit_SET)
#define VIIC_SDA_DIR_OUT            
#define VIIC_SDA_DIR_IN             GPIO_SetBits(GPIOE,GPIO_Pin_12)
#endif
