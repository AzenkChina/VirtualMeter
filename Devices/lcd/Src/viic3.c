...
#define VIIC_SDA_L					GPIO_ResetBits(GPIOE,GPIO_Pin_10)
#define VIIC_SDA_H					GPIO_SetBits(GPIOE,GPIO_Pin_10)
#define VIIC_SDA_DATA               GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_10)
